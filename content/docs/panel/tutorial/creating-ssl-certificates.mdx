...
applied assuming that you've already configured the webservers to use SSL as instructed in the [web server configuration step](https://kifzl-x-pterodactyl.dev/docs/panel/webserver-configuration).
