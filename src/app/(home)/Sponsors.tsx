        ...
        <div className="grid items-center divide-y divide-black/20 dark:divide-zinc-800 lg:grid-cols-2 lg:divide-x lg:divide-y-0">
          ...
          <p className="p-4">
            <span className="opacity-75">
              Kifzl X Pterodactyl is built by community for the community. This means
              Kifzl X Pterodactyl is not built to earn profit.
            </span>{" "}
            <Link
              className="text-link"
              href="https://github.com/byy-nexa/panel"
            >
              Support our work by donating to Kifzl X Pterodactyl.
            </Link>
          </p>
        </div>
      </div>
      <div className="flex items-center md:min-h-44">
        <div className="flex w-full flex-col justify-center gap-4 p-4 md:flex-row md:gap-12 md:p-6 text-center">
          <p className="text-fd-muted-foreground italic">
            &quot;Your support helps Kifzl X Pterodactyl grow.&quot;
          </p>
        </div>
      </div>
    </section>
