        ...
        {[
          {
            ...
            description:
              'Documentation for Kifzl X Pterodactyl panel.',
          ...
          },
          {
            ...
            description:
              'Join the official telegram community for Kifzl X Pterodactyl.',
          ...
          return (
            <Item key={index} href={item.href} target={itemAny.target} rel={itemAny.rel}>
              <Icon>{item.icon}</Icon>
              <h2 className="mb-2 font-medium">{itemAny.name}</h2>
