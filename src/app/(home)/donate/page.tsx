...
export const metadata: Metadata = {
    openGraph: {
        title: "Make Donation to Kifzl X Pterodactyl Project",
        description: "Your donations help us dedicate more time to developing new features and improving Kifzl X Pterodactyl.",
    },
};
