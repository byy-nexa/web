...
const features = [
  {
    ...
    description:
      "Kifzl X Pterodactyl is compatible with almost every addon that was made for Pterodactyl panel.",
  },
  {
    icon: <FaLock />,
    title: "Security First",
    description: "Kifzl X Pterodactyl is most secure panel as we actively work on patching vulerabilities. ",
  },
  {
    icon: <FaPaintRoller />,
    title: "Modern Design",
    description: "Kifzl X Pterodactyl offers better and more accessible UI design that doesn't feel outdated.",
  },
  {
    icon: <FaBook />,
  ...
  },
  {
    icon: <FaCodeFork />,
    title: "Open Source",
    description: "Kifzl X Pterodactyl is open-source, allowing community contributions and customization to improve server managing experience.",
  },
  {
    icon: <FaBoxesPacking />,
    title: "Feature-Packed",
    description: "Kifzl X Pterodactyl offers top-notch features such as Client-Side Theme Selector, Designify Theme Editor, Custom Branding, and much more.",
  },
];
